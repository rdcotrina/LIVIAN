...
$.sound_path = "public/js/notification/sound//", $.sound_on = !0, jQuery(document).ready(function() {
...
$.SmartMessageBox = function(a, b) {
    ...
    for (var i = 0; i <= a.buttons.length - 1; i++) "[" == a.buttons[i] ? j = "" : "]" == a.buttons[i] ? (k += 1, j = "<button id='bot" + k + "-Msg" + SmartMSGboxCount + "' class='btn btn-default btn-xs botTempo' style='color:#333'> " + j + "</button>", d += j) : j += a.buttons[i];
